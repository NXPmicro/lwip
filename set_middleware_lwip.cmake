...
if(CONFIG_USE_middleware_lwip_template AND (CONFIG_USE_middleware_lwip_usb_ethernetif OR CONFIG_USE_middleware_lwip_mcx_ethernetif OR CONFIG_USE_middleware_wifi))
...
if (CONFIG_USE_middleware_lwip_mcx_ethernetif)
# Add set(CONFIG_USE_middleware_lwip_mcx_ethernetif true) in config.cmake to use this component

message("middleware_lwip_mcx_ethernetif component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_middleware_lwip AND CONFIG_USE_middleware_lwip_template AND CONFIG_USE_driver_phy-common AND CONFIG_USE_driver_mcx_enet AND (CONFIG_USE_component_gpio_adapter))
...
message(SEND_ERROR "middleware_lwip_mcx_ethernetif dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_middleware_lwip AND CONFIG_USE_middleware_usb_host_cdc AND CONFIG_USE_middleware_usb_host_cdc_rndis AND (CONFIG_USE_middleware_usb_host_khci OR CONFIG_USE_middleware_usb_host_ehci))
