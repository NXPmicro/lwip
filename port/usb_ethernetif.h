...
#define CDC_ECM_REQUEST_SET_ETH_MC_FL           (1U << 0)
#define CDC_ECM_REQUEST_SET_ETH_PWR_MGMT_PAT_FL (1U << 1)
#define CDC_ECM_REQUEST_GET_ETH_PWR_MGMT_PAT_FL (1U << 2)
#define CDC_ECM_REQUEST_SET_ETH_PKT_FL          (1U << 3)
#define CDC_ECM_REQUEST_GET_ETH_STATS           (1U << 4)
#define CDC_ECM_REQUEST_MASK                                                   \
    (CDC_ECM_REQUEST_SET_ETH_MC_FL | CDC_ECM_REQUEST_SET_ETH_PWR_MGMT_PAT_FL | \
     CDC_ECM_REQUEST_GET_ETH_PWR_MGMT_PAT_FL | CDC_ECM_REQUEST_SET_ETH_PKT_FL | CDC_ECM_REQUEST_GET_ETH_STATS)
#elif defined(USB_HOST_CONFIG_CDC_RNDIS) && USB_HOST_CONFIG_CDC_RNDIS
...
typedef enum _usb_host_cdc_ecm_run_state_enum
{
    ...
    USB_HostCdcEcmRunNetworkDisconnect,
    USB_HostCdcEcmRunNetworkConnected,
    USB_HostCdcEcmRunNetworkSpeedChange,
    USB_HostCdcEcmRunDataRecv,
...
typedef struct _usb_host_cdc_ecm_instance_struct
{
    ...
    EventGroupHandle_t netifUsbRequestEvent;
#endif
